    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.payment')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
        ...
        migrations.AddField(
            model_name='payment',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.seller'),
        ),
        migrations.AddField(
            model_name='order',
            name='product',
